...
server.registerTool("export_diagram", {
    description: "Export the current diagram to a file. Supports .drawio (XML), .png, and .svg formats. " +
        "The format is auto-detected from the file extension, or can be specified explicitly.",
    inputSchema: {
        path: z
            .string()
            .describe("File path to save the diagram (e.g., ./diagram.drawio, ./diagram.png, ./diagram.svg)"),
        format: z
            .enum(["drawio", "png", "svg"])
            .optional()
            .describe("Export format. If omitted, detected from file extension. Defaults to drawio."),
    },
}, async ({ path, format }) => {
    try {
        if (!currentSession) {
